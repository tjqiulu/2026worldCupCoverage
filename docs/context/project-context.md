...
- **Active plan**: [`002-ics-parser-and-flask.md`](../plans/002-ics-parser-and-flask.md)（已完成）+ [`027-standings-team-name-alias-resolver.md`](../plans/027-standings-team-name-alias-resolver.md)（2026-06-19 完成）
- **Active backlog item**: `P0-004`（国旗 + 队名）→ Plan 003 候选
- **AI autonomy**: plan-first（任何 `src/` 改动都要先有 plan）
- **Current blocker**: none
- **Documentation freshness**: **fresh**（2026-06-19 Plan 027 完成）
